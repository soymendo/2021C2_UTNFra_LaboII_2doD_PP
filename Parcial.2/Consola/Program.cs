...
namespace Consola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Cliente cliente1 = new Cliente("oscar", "carabajal", 23456643, 35, Petisiones.SoftwareInstalado.icq, Petisiones.PeriféricosDisponibles.auriculares, (Petisiones.JuegosDisponibles)1);
